...
@Component
public class BandQuoteRequestTemplateHandler extends EmailTemplateHandler {

    @Value("${band.quote.requests.url}")
    private String bandQuoteRequestsLink;

    public BandQuoteRequestTemplateHandler(final FindEmailTemplateUseCase findEmailTemplateUseCase) {
        super(findEmailTemplateUseCase);
    }

    @Override
    public Long getHandledTemplateId() {
        return EmailRequestType.NEW_BAND_QUOTE_REQUEST.getTemplateId();
    }
